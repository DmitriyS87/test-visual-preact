...
import ArrowIcon from "../../assets/ad-arrow.svg";
...
const AdBanner = ({ forwardRef = null }) => {
  ...
  return (
    <section
      ref={forwardRef}
      className={styles.rowBanner}
      aria-label="Advertising banner. You can use promo code to get a discount."
    >
      <div className={styles.rowBannerContent}>
        <p className={styles.adTextBlock}>
          ...
          <span className={styles.rowBannerDivider}>
            <img className={styles.point} src={PointIcon} alt="divider" />
          </span>
          ...
          <span className={styles.rowBannerOffer}>
            Use code{" "}
            <span className={styles.cardCode} aria-label="Promo code">
              10friday
            </span>{" "}
